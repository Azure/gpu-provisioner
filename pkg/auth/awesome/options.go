...
// AgentPoolNodeOSUpgradeSettings - [Internal Only] The agent pool node os upgrade settings
type AgentPoolNodeOSUpgradeSettings struct {
	// READ-ONLY; The security vhd target.
	SecurityVhdTarget *SecurityVhdTarget
}

// SecurityVhdTarget - The security vhd target.
type SecurityVhdTarget string

// AdminAgentPoolsClientBeginLiveUpgradeSecurityPackagesOptions contains the optional parameters for the AdminAgentPoolsClient.BeginLiveUpgradeSecurityPackages
// method.
type AdminAgentPoolsClientBeginLiveUpgradeSecurityPackagesOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}

// AdminManagedClustersClientDeleteNodeResourceGroupDenyAssignmentsOptions contains the optional parameters for the AdminManagedClustersClient.DeleteNodeResourceGroupDenyAssignments
// method.
type AdminManagedClustersClientDeleteNodeResourceGroupDenyAssignmentsOptions struct {
	// Whether to delete deny assignment on the node resource group forcefully.
	ForceDelete *bool
...
// AdminManagedClustersClientListCustomerControlPlaneEventsOptions contains the optional parameters for the AdminManagedClustersClient.ListCustomerControlPlaneEvents
// method.
type AdminManagedClustersClientListCustomerControlPlaneEventsOptions struct {
	// placeholder for future optional parameters
}

// AdminManagedClustersClientListCustomerControlPlanePodsOptions contains the optional parameters for the AdminManagedClustersClient.ListCustomerControlPlanePods
// method.
type AdminManagedClustersClientListCustomerControlPlanePodsOptions struct {
	// placeholder for future optional parameters
}

// AdminManagedClustersClientListOptions contains the optional parameters for the AdminManagedClustersClient.NewListPager
// method.
type AdminManagedClustersClientListOptions struct {
	// placeholder for future optional parameters
}

// AdminManagedClustersClientMigrateCustomerControlPlaneOptions contains the optional parameters for the AdminManagedClustersClient.MigrateCustomerControlPlane
// method.
type AdminManagedClustersClientMigrateCustomerControlPlaneOptions struct {
	// placeholder for future optional parameters
}

// AdminManagedClustersClientUpdateTLSBootstrapTokenOptions contains the optional parameters for the AdminManagedClustersClient.UpdateTLSBootstrapToken
// method.
type AdminManagedClustersClientUpdateTLSBootstrapTokenOptions struct {
	// placeholder for future optional parameters
}

// AdminUnderlayClientCreateOrUpdateOptions contains the optional parameters for the AdminUnderlayClient.CreateOrUpdate method.
type AdminUnderlayClientCreateOrUpdateOptions struct {
	// placeholder for future optional parameters
}

// AdminUnderlayClientDrainControlPlanesOptions contains the optional parameters for the AdminUnderlayClient.DrainControlPlanes
// method.
type AdminUnderlayClientDrainControlPlanesOptions struct {
	// placeholder for future optional parameters
}

// AdminUnderlayClientQuarantineUnderlayOptions contains the optional parameters for the AdminUnderlayClient.QuarantineUnderlay
// method.
type AdminUnderlayClientQuarantineUnderlayOptions struct {
	// placeholder for future optional parameters
}

// AdminUnderlayClientUnquarantineUnderlayOptions contains the optional parameters for the AdminUnderlayClient.UnquarantineUnderlay
// method.
type AdminUnderlayClientUnquarantineUnderlayOptions struct {
	// placeholder for future optional parameters
}
...
// AgentPoolsClientBeginCaptureSecurityVHDSnapshotOptions contains the optional parameters for the AgentPoolsClient.BeginCaptureSecurityVHDSnapshot
// method.
type AgentPoolsClientBeginCaptureSecurityVHDSnapshotOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
...
type AgentPoolsClientBeginUpgradeNodeImageVersionOptions struct {
	// [Internal Only] The agent pool node os upgrade settings.
	Parameters *AgentPoolNodeOSUpgradeSettings
...
// ManagedClustersClientBeginResetNodeIdentityProfileOptions contains the optional parameters for the ManagedClustersClient.BeginResetNodeIdentityProfile
// method.
type ManagedClustersClientBeginResetNodeIdentityProfileOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
...
type ManagedClustersClientBeginRotateClusterCertificatesOptions struct {
	// [Internal Only] The rotate cert profile.
	Parameters *RotateCertProfile
...
type ManagedClustersClientBeginRotateServiceAccountSigningKeysOptions struct {
	...
	// expiration in seconds for rotated Service Account Signing Key
	RotatedExpirationTime *string

	// expiration in seconds for rotating Service Account Signing Key
	RotatingExpirationTime *string
}
...
// ManagedClustersClientBeginUnpinOptions contains the optional parameters for the ManagedClustersClient.BeginUnpin method.
type ManagedClustersClientBeginUnpinOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
...
// ManagedClustersClientPreflightOptions contains the optional parameters for the ManagedClustersClient.Preflight method.
type ManagedClustersClientPreflightOptions struct {
	// placeholder for future optional parameters
}

// NetworkSecurityPerimetersClientBeginCreateOrUpdateOptions contains the optional parameters for the NetworkSecurityPerimetersClient.BeginCreateOrUpdate
// method.
type NetworkSecurityPerimetersClientBeginCreateOrUpdateOptions struct {
	// Resumes the LRO from the provided token.
	ResumeToken string
}
...
// OperationStatusResultClientGetByIDOptions contains the optional parameters for the OperationStatusResultClient.GetByID
// method.
type OperationStatusResultClientGetByIDOptions struct {
	// placeholder for future optional parameters
}
