...
skugen() {
  ...
  go run hack/code/instancetype_testdata_gen.go -- "${GENERATED_FILE}" "" "Standard_D2_v2,Standard_D2_v3,Standard_DS2_v2,Standard_D2s_v3,Standard_D2_v5,Standard_F16s_v2,Standard_NC24ads_A100_v4"
